...
public class WanaKana
{
    ...
    public WanaKana(EditText et, Boolean useObsoleteKana)
    {
        gInputWindow = et;
    ...
    public String _romajiToKana(String roma, Boolean ignoreCase)
    {
        String chunk = "";
        String chunkLC = "";
        int chunkSize;
    ...
    public String toKana(String input)
    {
        ...
        String kana = _romajiToKana(input, false);
        //davidr edited********
        if(kana.length() > 0 && kana.substring(kana.length()-1).equals("n"))
